...
This module works with CMake generator expressions as far as I know. Some special properties that cannot be passed to `add_custom_command` need to be filtered out.
...
* `libzig.h` was written manually. It will probably be generated by Zig in the future.
...
Zig error printed from the C application (`NULL` was passed to the encoding function)

```bash
Build type:   Debug
S.N (96b):    002400534B42500620343431
Error when encoding: BufferEmpty (-6) # Zig error
